...
/** A node that checks to see if zero-page login headers have specified username and shared key for this request. */
@Node.Metadata(outcomeProvider = AbstractDecisionNode.OutcomeProvider.class,
        configClass = ZeroPageUsernameSecretNode.Config.class)
public class ZeroPageUsernameSecretNode extends AbstractDecisionNode {

    private final Config config;
    private final CoreWrapper coreWrapper;
    private final static String DEBUG_FILE = "ZeroPageUsernameSecretNode";
     ...
     */
    @Inject
    public ZeroPageUsernameSecretNode(@Assisted Config config, CoreWrapper coreWrapper) throws NodeProcessException {
        this.config = config;
