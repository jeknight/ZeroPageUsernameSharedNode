 ...
 */
public class ZeroPageUsernameSecretNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public ZeroPageUsernameSecretNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
    ...
    protected Iterable<? extends Class<? extends Node>> getNodes() {
        return asList(
                ZeroPageUsernameSecretNode.class
        );
    }
}
